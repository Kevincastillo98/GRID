  ...
  <nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" id="navbar-content">
      <ul class="nav navbar-nav">
        ...
        <li class="${('', 'active')[page=='libreria']}"><a href="${tg.url('/libreria/libreria')}">Solicitantes</a></li>
        <li class="${('', 'active')[page=='entrevistador']}"><a href="${tg.url('/libreria/entrevistador')}">Entrevistador</a></li>
         <li class="${('', 'active')[page=='agenda']}"><a href="${tg.url('/libreria/relacion')}">Agenda</a></li>
      </ul>
