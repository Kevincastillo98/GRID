...
def bootstrap(command, conf, vars):
    ...
    try:
        ...
        u2 = model.User()
        u2.user_name = 'editor2'
        u2.display_name = 'Example editor2'
        u2.email_address = 'editor2@somedomain.com'
        u2.password = 'editpass2'

        model.DBSession.add(u2)

        h = model.Distribuciones()
        h.id = 1
        h.imei = '0987654365769854'
        h.ticket = 9
        h.name = 'Victor Victorias'
